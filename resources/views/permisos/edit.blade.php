@extends('layouts.main', ['activePage' => 'permisos', 'titlePage' => __('Editar Permiso')])
    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-md-4">
          ...
          <form class="form" method="POST" action="{{ route('permission.update', $permission) }}">
            @csrf
            {{-- method_field('PUT') --}}
            @method('PUT')
              ...
              <div class="card-body ">
                ...
                <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                  <div class="input-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="{{ __('Nombre del permiso...') }}"
